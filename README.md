...
|------------|----------|-------------|
| SIMPLE | Git rewrites, file renames, config changes, running commands | Quick sanity check (single attempt) |
...
Simple tasks that fail the sanity check are automatically upgraded to full review.
